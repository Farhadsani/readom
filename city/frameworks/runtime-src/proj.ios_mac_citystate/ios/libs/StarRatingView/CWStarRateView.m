...
#define FOREGROUND_STAR_IMAGE_NAME @"store_star_yellow"
#define BACKGROUND_STAR_IMAGE_NAME @"store_star_gray"
...
- (UIView *)createStarViewWithImage:(NSString *)imageName {
    ...
    CGFloat padding = 5;
    CGFloat imageViewW = (self.bounds.size.width - (self.numberOfStars - 1) * padding) / self.numberOfStars;
    for (NSInteger i = 0; i < self.numberOfStars; i ++)
    {
        UIImageView *imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:imageName]];
        imageView.frame = CGRectMake(i * (imageViewW + padding), 0, imageViewW, self.bounds.size.height);

...
+ (void)initialize{
    [[UINavigationBar appearance] setBackgroundImage:[UIImage imageWithColor:yello_color] forBarMetrics:UIBarMetricsDefault];
    [[UINavigationBar appearance] setBarStyle:UIBarStyleDefault];
    [UINavigationBar appearance].shadowImage = [[[UIImage alloc] init] autorelease];
    [[UINavigationBar appearance] setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
                                                          [UIColor color:darkblack_color], NSForegroundColorAttributeName,
                                                          [UIFont fontWithName:k_fontName_FZZY size:k_defaultNavTitleFontSize], NSFontAttributeName,
                                                          nil]];
}

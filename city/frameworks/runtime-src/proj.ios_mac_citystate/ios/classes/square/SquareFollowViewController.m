...
#import "SquareFollowViewController.h"
#import "MJRefresh.h"
#import "BuddyStatusCell.h"
#import "TagItem.h"


@interface SquareFollowViewController ()<UITableViewDataSource, UITableViewDelegate, BuddyStatusCellDelegate>
...
@implementation SquareFollowViewController
...
- (void)viewDidLoad {
    ...
    //    tableView.frame = CGRectMake(0, self.titleBar.y+self.titleBar.height, self.view.width, self.contentView.bounds.size.height-self.titleBar.y-self.titleBar.height);
...
- (void)didFinishLoad:(Reqest *)req responseData:(NSData *)responseData result:(id)result{
    ...
    if ( ((NSNumber*)[req.data_dict objectOutForKey:k_r_postData][@"params"][@"userid"]).intValue == 20000007) {

...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    PetMsgCell *cell = [tableView dequeueReusableCellWithIdentifier:@"PetMsgCell"];
    if (cell == nil) {
        cell = [[[PetMsgCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:@"PetMsgCell" data:[_list objectAtExistIndex:indexPath.row]] autorelease];
    }
...
- (void)setupMainView{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(cellDelete:) name:@"petCellDelete" object:nil];
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(cellUserZone:) name:@"petCellUserZone" object:nil];
}
...
{
    PetMsgCell *cell = notification.userInfo[@"cell"];

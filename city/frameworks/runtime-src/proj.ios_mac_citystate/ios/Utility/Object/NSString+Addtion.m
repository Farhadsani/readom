...
+ (NSAttributedString *)attrContent:(NSString *)text fontName:(NSString *)fontName fontsize:(CGFloat)fontsize color:(UIColor *)color lineHeight:(CGFloat)lineHeight align:(NSTextAlignment)align{

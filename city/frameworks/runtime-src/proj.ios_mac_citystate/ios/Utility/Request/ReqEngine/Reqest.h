...
#define k_r_printLog        @"printLog"         //没有值表示默认打印日志，0：不打印日志，1：表示打印日志；
...
@interface Reqest : NSObject <TKHTTPRequestProgressDelegate,NSURLConnectionDelegate, LoginVCDelegate>

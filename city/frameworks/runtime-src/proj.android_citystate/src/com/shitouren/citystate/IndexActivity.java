...
public class IndexActivity extends Activity implements OnClickListener, IActivity {
	...
	// topBarLayout布局
	private static LinearLayout llTopbarLeft;
	private static ImageView ivTopbarleft;

	private static TextView tvTopbarMiddle;
	
	private static RelativeLayout rlTopBarRight;
	private static ImageView ivTopBarRight;
	// topBarLayout布局
	...
	public void setLisener() {
		llTopbarLeft.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				ActivityUtils.startActivity(IndexActivity.this, NearbyActivity.class);
			}
		});
		rlTopBarRight.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				ActivityUtils.startActivity(IndexActivity.this, IndexSocialActivity.class);
			}
		});
	}
	...
	private static void initTopBarLayout() {
		if(name.equals("index")){
			ivTopbarleft.setVisibility(View.VISIBLE);
			ivTopbarleft.setImageResource(R.drawable.fujin);
			
			tvTopbarMiddle.setText("指数");

			ivTopBarRight.setVisibility(View.VISIBLE);
			ivTopBarRight.setImageResource(R.drawable.fenlei);
		}else{
			ivTopbarleft.setVisibility(View.VISIBLE);
			ivTopbarleft.setImageResource(R.drawable.erweima);
			
			tvTopbarMiddle.setText("我的");

			ivTopBarRight.setVisibility(View.VISIBLE);
			ivTopBarRight.setImageResource(R.drawable.wodeqianbao);
		}

...
- (void)TEST{
#ifdef k_LOCAL_CODE_TEST_MODEL
    NSDictionary * dc = @{@"id":@"18263262348",
                          k_userid:@"182176749434",
                          k_password:@"dstgyuwg7ef",
                          k_login_status:str(S_Login_Out)
                          };
    [_user_dict setNonEmptyValuesForKeysWithDictionary:dc];

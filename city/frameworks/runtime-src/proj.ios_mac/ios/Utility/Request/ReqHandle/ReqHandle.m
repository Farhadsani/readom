...
- (ASIFormDataRequest *)asiFormDataRequestWithType:(Reqest *)req postStr:(NSString *)postString{
    ...
    if (req.methodType == M_POST) {
        ...
        [request setRequestHeaders:[NSMutableDictionary dictionaryWithObject:@"shitouren_qmap_ios" forKey:@"User-Agent"]];
...
//    AFHTTPRequestOperationManager *request = nil;
    ...
    [request.requestSerializer setValue:@"shitouren_qmap_ios" forHTTPHeaderField:@"User-Agent"];

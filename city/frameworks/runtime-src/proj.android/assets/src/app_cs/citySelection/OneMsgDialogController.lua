...
local OneMsgDialogController = class("OneMsgDialogController", require(QMapGlobal.app.packageRoot .. "/controllers/ViewController"))
...
function OneMsgDialogController:ctor(param)
    ...
    self._viewClassPath = self.packageRoot .. "/citySelection/OneMsgDialogView"

...
-- 打开个人主页
openUserHome = function ( callBack )
    return lua_openUserHome and lua_openUserHome(callBack)
end

-- 刷新个人主页
refreshUserCenter = function ( callBack )
    return lua_refreshUserHome and lua_refreshUserHome( callBack )
end

goback = function (  )
    return lua_goback and lua_goback()
end

userLogin = function ( autoLogin, callBack )
    return lua_userLogin and lua_userLogin(autoLogin, callBack)
end

openAbout = function ( callBack )
    return lua_openAbout and lua_openAbout(callBack)
end
...
onMainPage = function ( callBack )
    return lua_onMainPage(callBack)
end

openSightIntro = function ( sightID, sightName, sightDesc, callBack )
    return lua_openSightIntro(sightID, sightName, sightDesc, callBack)
end

openCategory = function ( sightID, categoryType, categoryID, callBack )
    return lua_openCategory( sightID,categoryType, categoryID, callBack )
end

sceneLoadOver = function ( sceneName )
    return lua_sceneLoadOver(sceneName)
end

openHotBall = function ( userID, callBack )
    return lua_openHotBall(userID, callBack)
end

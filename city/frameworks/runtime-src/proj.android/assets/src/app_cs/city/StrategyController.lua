...
local StrategyController = class("StrategyController", require(QMapGlobal.app.packageRoot .. "/controllers/ViewController"))
...
function StrategyController:ctor(param)
    ...
    self._viewClassPath = self.packageRoot .. "/city/StrategyView"

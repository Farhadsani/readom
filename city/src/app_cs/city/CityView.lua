...
function CityView:_initUI(param)
    ...
    -- map layer
    self._mapLayer = require(viewPath .. "MapLayer").new(mapParam)
    self._mapLayer:addTo(self)

    -- menu layer
    self._menuLayer = require(viewPath .. "MenuLayer").new()
    ...
    -- 显示简介
    -- self._IntroduceLayer = require(viewPath .. "IntroduceLayer").new()
...
function CityView:reLoadView( param )
    -- body
    print("CityView...", param.categoryType, param.categoryID)
    local categoryType = param.categoryType or 0
    local categoryID = param.categoryID or 0


    self._mapLayer:refreshData(categoryType, param.datas)

    -- if categoryType == 0 then -- 景点
    -- elseif categoryType == 1 then --社交指数
    --     local datas = {
    --         ["1401000105"] = {count = 5}
    --     }
    --     local scheduler = require(cc.PACKAGE_NAME .. ".scheduler")
    --     scheduler.performWithDelayGlobal(function (  )
    --         self._mapLayer:refreshData(datas)
    --     end, 2)
    -- elseif categoryType == 2 then -- 热门标签
    --     local datas = {
    --         ["1401000105"] = {count = 9}
    --     }
    --     local scheduler = require(cc.PACKAGE_NAME .. ".scheduler")
    ...
    --         self._mapLayer:refreshData(datas)
    --     end, 2)
    -- elseif categoryType == 3 then -- 消费指数
    --     local datas = {
    --         ["1401000105"] = {count = 9}
    --     }
    --     local scheduler = require(cc.PACKAGE_NAME .. ".scheduler")
